...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jsondiff-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3021&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jsondiff-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jsondiff` can be installed with:

```
conda install jsondiff
```

It is possible to list all of the versions of `jsondiff` available on your platform with:
